 ...
 * concern.
 *
 * The movement-speed and heart-rate inputs are not wired yet. An input that is
 * absent here is indistinguishable from one reporting itself unavailable: its
 * dimension is held at 5 and it contributes nothing to the aggregate.
 *
